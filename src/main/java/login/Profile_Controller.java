        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                if(user1.getImage().equals("")){
                    profilePicture = new Image("file:///F:/Codes/Intelli J/donationtracker-master-finalmergetesting/src/main/resources/login/profilepictures/defaultAvatar.jpg");
                }
                else {
...
//            String imagePath = "F:\\Codes\\Intelli J\\donationtracker-master-finalmergetesting\\src\\main\\resources\\login\\profilepictures\\defaultAvatar.jpg";
//
        ...
        try {
            ...
            if (chosenFile != null) {
                ...
                try {
                    ...
                    OutputStream os = new FileOutputStream("F:\\Codes\\Intelli J\\donationtracker-master-finalmergetesting\\src\\main\\resources\\login\\profilepictures\\" + USERNAME + ".jpg");
                ...
                newImagePath = "file:///F:/Codes/Intelli J/donationtracker-master-finalmergetesting/src/main/resources/login/profilepictures/" + USERNAME + ".jpg";
            }
            else {
            ...
            profilePicture = new Image(newImagePath);
            profileView.setImage(profilePicture);
