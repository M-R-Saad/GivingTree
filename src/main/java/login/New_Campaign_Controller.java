        ...
        try {
            ...
            if (chosenFile != null) {
                ...
                try {
                    ...
                    OutputStream os = new FileOutputStream("F:\\Codes\\Intelli J\\donationtracker-master-finalmergetesting\\src\\main\\resources\\login\\campaignpictures\\" + campaignPicture + ".jpg");
                    campaignPicture++;
                ...
                campaignImagePath = "file:///F:/Codes/Intelli J/donationtracker-master-finalmergetesting/src/main/resources/login/campaignpictures/" + campaignPicture + ".jpg";
                selectImageLabel.setText(campaignImagePath);
            }
            else {

                campaignImagePath = "file:///F:/Codes/Intelli J/donationtracker-master-finalmergetesting/src/main/resources/login/campaignpictures/defaultBackground.jpg";
                selectImageLabel.setText(campaignImagePath);
            }
